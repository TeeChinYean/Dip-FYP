...
$query = "SELECT bill_master.*, bill_master_transaction.*, product.*, customer.*
          ...
          WHERE bill_master.Customer_ID = $Customer_ID
...
if ($result->num_rows > 0) {
    ...
    die("No data found for the specified customer.");
}
...
$pdf -> Cell(10, 5, '', 0, 0);
$pdf -> Cell(90, 5, $invoice_data[0]['Billing_Address_Line1'], 0, 1);

$pdf -> Cell(10, 5, '', 0, 0);
$pdf -> Cell(90, 5, $invoice_data[0]['Billing_Address_Line2'], 0, 1);

$pdf -> Cell(10, 5, '', 0, 0);
$pdf -> Cell(90, 5, $invoice_data[0]['Billing_Address_Line3'], 0, 1);

$pdf -> Cell(10, 5, '', 0, 0);
$pdf -> Cell(90, 5, $invoice_data[0]['Billing_Address_Line4'], 0, 1);

$pdf -> Cell(10, 5, '', 0, 0);
$pdf -> Cell(90, 5, $invoice_data[0]['Customer_Phone_Number'], 0, 1);
...
$pdf -> SetFont('Arial', 'B', 12);
$pdf -> Cell(55, 5, 'CUSTOMER REMARKS :', 0, 1);

$pdf -> SetFont('Arial', '', 12);
$pdf -> Cell(90, 15, $invoice_data[0]['Remark'], 0, 1);
